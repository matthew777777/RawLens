#version 450
// generated by tools/srvk_shader_transform.py from rawsr/block_match.glsl (sources stay ESSL)
layout(binding = 4, std140) uniform SrUniforms {
    highp uvec3 u_dispatch_offset; // src:2
    ivec2 u_size,u_tile_grid,u_previous_grid; // src:9
    int u_tile_size,u_search_radius,u_has_initial_flow,u_scale,u_l1; // src:10
    float u_min_fraction; // src:11
};
...
layout(binding = 2) uniform sampler2D u_initial_flow;
layout(binding = 3, rgba32f) writeonly uniform highp image2D img_flow;
