#version 450
// generated by tools/srvk_shader_transform.py from rawsr/clear_accumulators.glsl (sources stay ESSL)
...
layout(binding = 2, r32f) writeonly uniform highp image2D oob;
layout(binding = 3, rgba32f) writeonly uniform highp image2D near_numerator;
layout(binding = 4, rgba32f) writeonly uniform highp image2D near_denominator;
void main() {
