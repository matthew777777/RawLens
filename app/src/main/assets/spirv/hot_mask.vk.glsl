#version 450
// generated by tools/srvk_shader_transform.py from rawsr/hot_mask.glsl (sources stay ESSL)
layout(binding = 2, std140) uniform SrUniforms {
    highp uvec3 u_dispatch_offset; // src:2
    ivec2 u_size; // src:25
    float u_white; // src:26
    vec4 u_slope; // src:27
    vec4 u_offset; // src:28
    int u_model_valid; // src:29
};
...
layout(binding = 1, r32ui) writeonly uniform highp uimage2D img_mask;
