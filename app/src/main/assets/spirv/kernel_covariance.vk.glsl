#version 450
// generated by tools/srvk_shader_transform.py from rawsr/kernel_covariance.glsl (sources stay ESSL)
layout(binding = 2, std140) uniform SrUniforms {
    highp uvec3 u_dispatch_offset; // src:2
    ivec2 u_size; // src:17
    float u_k_detail; // src:18
    float u_k_denoise; // src:19
    float u_d_th; // src:20
    float u_d_tr; // src:21
    float u_k_stretch; // src:22
    float u_k_shrink; // src:23
    int u_kernel_type; // src:24
    int u_selection_law; // src:25
};
...
layout(binding = 1, rgba32f) writeonly uniform highp image2D img_cov;
