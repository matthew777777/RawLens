#version 450
// generated by tools/srvk_shader_transform.py from rawsr/linear_guide.glsl (sources stay ESSL)
layout(binding = 2, std140) uniform SrUniforms {
    highp uvec3 u_dispatch_offset; // src:2
    ivec2 u_size; // src:15
    ivec4 u_fc; // src:16
    vec4 u_black; // src:17
    float u_white; // src:18
    vec4 u_slope; // src:19
    vec4 u_offset; // src:20
    int u_model_valid; // src:21
};
...
layout(binding = 1, rgba32f) writeonly uniform highp image2D img_linear;
