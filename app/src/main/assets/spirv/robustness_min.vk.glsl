#version 450
// generated by tools/srvk_shader_transform.py from rawsr/robustness_min.glsl (sources stay ESSL)
...
layout(binding = 1, r32f) writeonly uniform highp image2D img_r;
void main() {
