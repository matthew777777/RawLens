#version 450
// generated by tools/srvk_shader_transform.py from rawsr/unblocker_modulate.glsl (sources stay ESSL)
layout(binding = 5, std140) uniform SrUniforms {
...
layout(binding = 0) uniform sampler2D u_r;
layout(binding = 1) uniform sampler2D u_u;
layout(binding = 2) uniform highp usampler2D u_flags_in;
layout(binding = 3, r32f) writeonly uniform highp image2D img_r;
layout(binding = 4, r32ui) writeonly uniform highp uimage2D img_flags;
