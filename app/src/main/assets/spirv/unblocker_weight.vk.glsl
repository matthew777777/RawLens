#version 450
// generated by tools/srvk_shader_transform.py from rawsr/unblocker_weight.glsl (sources stay ESSL)
layout(binding = 3, std140) uniform SrUniforms {
    highp uvec3 u_dispatch_offset; // src:2
    ivec2 u_size; // src:23
    ivec2 u_half_size; // src:24
    vec2 u_ab; // src:25
    int u_model_valid; // src:26
};
...
layout(binding = 1) uniform sampler2D u_half;
layout(binding = 2, r32f) writeonly uniform highp image2D img_weight;
