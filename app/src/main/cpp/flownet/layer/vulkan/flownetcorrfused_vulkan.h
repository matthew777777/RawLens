...
#ifndef LAYER_FLOWNET_CORR_FUSED_VULKAN_H
#define LAYER_FLOWNET_CORR_FUSED_VULKAN_H

#include "flownetcorrfused.h"

namespace ncnn {

class FlownetCorrFused_vulkan : public FlownetCorrFused
{
public:
    FlownetCorrFused_vulkan();

    using FlownetCorrFused::forward;
...
private:
    Pipeline* pipeline_flownet_corr_fused;
};

} // namespace ncnn

#endif // LAYER_FLOWNET_CORR_FUSED_VULKAN_H
