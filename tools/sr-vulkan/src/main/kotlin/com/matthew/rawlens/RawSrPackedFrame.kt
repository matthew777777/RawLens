...
class RawSrPackedFrame(
    ...
    neutralColorPoint: ImmutableDoubleValues? = null
) {
    ...
    internal val highlightNeutral = RawSrHighlights.normalizeNeutral(neutralColorPoint?.toDoubleArray())
    ...
    companion object {
        fun fromMetadata(plane: ByteBuffer, metadata: RawFrameMetadata): RawSrPackedFrame {
            ...
            return RawSrPackedFrame(plane,
                ...
                RawPreDemosaicPipeline.lensShadingModel(metadata), metadata.noiseProfile, metadata.neutralColorPoint)
        }
    }
}
